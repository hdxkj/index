					    ...
					    $.ajax({
							    ...
							    success:function(msg){
							    	...
							    	$.each(msg.data.paper,function(infoIndex,info){
											strHtmlPaper +=	"<div class='collection-list' onclick='window.location.href=\"news.html?id="+info.seqid+"\"'><div class='main'><dl><dt><a><img style='width:90px' src='"+baseUrl+"source/"+info.thumbnail+"' class='fl' /></a><span></span><i>"+info.createdtime.substr(0,10)+"</i></dt><dd><!--<img src='"+baseUrl+"source/"+info.thumbnail+"' class='fl' />--><ol><li>"+info.title+"</li><li></li></ol></dd></dl></div></div>";
							    	})
						...
						userHtml: function(m){
							...
							$.ajax({
								...
								success:function(msg){
									var strHtml = ""
									var info = msg.data
									strHtml += "<dl><dt><a><img src='images/mobile/ico-2.png' /></a>"+info.nickname+"</dt><dd><a href='collection.html'><img src='images/mobile/ico-3.png' />我的收藏<img src='images/mobile/ico-5.png' /></a></dd><dd><a href='mybooklist.html'><img src='images/mobile/ico-4.png' />我的图书<img src='images/mobile/ico-5.png' /></a></dd><dd><a id='loginout' style='cursor:pointer' onclick='thingsFun.loginOut()'>登出</a></dd></dl>";
									$(m).html(strHtml)
								}
